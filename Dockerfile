...
RUN cd etc/nginx/conf.d/sites-enabled && ln -s ../sites-available/portfolio.conf . && ln -s ../sites-available/chat.conf . && ln -s ../sites-available/webstore.conf . && ln -s ../sites-available/webstoreapi.conf . && ln -s ../sites-available/music.conf .
